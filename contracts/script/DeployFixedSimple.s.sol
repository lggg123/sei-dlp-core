...
contract DeployFixedSimpleScript is Script {
    ...
    function logDeploymentSummary() internal view {
        ...
        console.log("\nUPDATE FRONTEND:");
        console.log("Add these to validTestnetVaults array in useEnhancedVaultDeposit.ts:");
        console.log("  '%s', // Native SEI Vault", nativeSEIVault);
        console.log("  '%s', // ERC20 USDC Vault", erc20Vault);
        console.log("============================================");
    }
}
