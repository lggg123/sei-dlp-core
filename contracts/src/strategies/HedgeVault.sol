...
contract HedgeVault is IStrategyVault, ERC20, Ownable, ReentrancyGuard {
    ...
    ) ERC20("Hedge BTC/SEI", "BTCLP") Ownable(_initialOwner) {
        vaultInfo = VaultInfo({
            name: "Hedge Strategy",
    ...
    function _executeHedgeRebalance(AIRebalanceParams calldata params) internal {
        // Delta-hedged position management logic
