...
contract SeiHypergrowthVault is IStrategyVault, ERC20, Ownable, ReentrancyGuard {
    ...
    ) ERC20("SEI Hypergrowth SEI/ETH", "HGLP") Ownable(_initialOwner) {
        vaultInfo = VaultInfo({
    ...
    function rebalance(
        ...
        _executeHypergrowthRebalance(params);
    ...
    function _executeHypergrowthRebalance(AIRebalanceParams calldata params) internal {
        // High-risk, high-reward SEI exposure logic
